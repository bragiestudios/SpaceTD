...
//**************************************ATIRADORES NÍVEL 2**************************************					
			...
			PRECO[NAVE_EXTRA_2_GELO]		= 50;
			PRECO[NAVE_EXTRA_2_TESLA]		= 50;
			...
			P_VENDA[NAVE_EXTRA_2_TESLA]		= PRECO[NAVE_EXTRA_2_TESLA]*.7;
			P_VENDA[NAVE_EXTRA_2_GELO]		= PRECO[NAVE_EXTRA_2_GELO]*.7;
			P_VENDA[NAVE_ATIRADOR_2_TERRA]	= PRECO[NAVE_ATIRADOR_2_TERRA]*.7;

//**************************************ATIRADORES NÍVEL 3**************************************			
			PRECO[NAVE_ATIRADOR_3_FERVE]	= 50;
			PRECO[NAVE_ATIRADOR_3_PEDRA]	= 50;
			PRECO[NAVE_EXTRA_3_GELO]		= 50;
			PRECO[NAVE_EXTRA_3_TESLA]		= 50;

			P_VENDA[NAVE_ATIRADOR_3_FERVE]	= PRECO[NAVE_ATIRADOR_3_FERVE]*.7;
			P_VENDA[NAVE_ATIRADOR_3_PEDRA]	= PRECO[NAVE_ATIRADOR_3_PEDRA]*.7;
			P_VENDA[NAVE_EXTRA_3_GELO]		= PRECO[NAVE_EXTRA_3_GELO]*.7;
			P_VENDA[NAVE_EXTRA_3_TESLA]		= PRECO[NAVE_EXTRA_3_TESLA]*.7;		
